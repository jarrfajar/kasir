                            ...
                            <h6>Nomor Kamar</h5>
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('kode_kamar') ?? $kamar->kode_kamar }}" name="kode_kamar" id="kode_kamar" placeholder="Nomor kamar">
                                        @error('kode_kamar')
                        ...
                        <div class="col">
                            <h6 class="">Tipe Kamar</h5>
                                <select class="form-select" name="tipe_kamar_id" id="tipe_kamar_id" aria-label="Default select example">{{ old('tipe_kamar_id') }}
                                    <option value="{{ $kamar->tipe_kamar->tipe_kamar }}" selected>{{ $kamar->tipe_kamar->tipe_kamar }}</option>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end">
                                ...
                                <button class="btn btn-primary mt-5">Ubah Kamar</button>
                            </div>
                        </div>
                    </div>
                </form>
